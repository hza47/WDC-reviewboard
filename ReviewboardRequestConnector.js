...
(function () {
    ...
    myConnector.getSchema = function (schemaCallback) {
        var schema = [];
        var cols = [{ id: "index", alias: "index", dataType: tableau.dataTypeEnum.float }, { id: "summary", alias: "summary", dataType: tableau.dataTypeEnum.string }, { id: "link", alias: "link", dataType: tableau.dataTypeEnum.string }, { id: "submitter", alias: "submitter", dataType: tableau.dataTypeEnum.string }, { id: "Time_added", alias: "Time_added", dataType: tableau.dataTypeEnum.date }, { id: "lastUpdated", alias: "Last_Updated", dataType: tableau.dataTypeEnum.date }, { id: "Issue_Open", alias: "Issue_Open_Count", dataType: tableau.dataTypeEnum.float }, { id: "Issue_Resolved", alias: "Issue_Resolved_Count", dataType: tableau.dataTypeEnum.float }, { id: "Ship_It_Count", alias: "Ship_It_Count", dataType: tableau.dataTypeEnum.float }, { id: "Target_People", alias: "Target_People", dataType: tableau.dataTypeEnum.string }, { id: "Target_Group", alias: "Target_Group", dataType: tableau.dataTypeEnum.string }];
                    ...
                    if (data.review_requests.length > 0) {
                        ...
                        while (counter < iterations) {
                            ...
                            var next = $.ajax({
                                ...
                                error: function error(next, ajaxOptions, thrownError) {
